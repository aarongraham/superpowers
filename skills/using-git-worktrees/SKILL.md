...
description: Use ONLY when user explicitly asks for worktree setup - creates isolated git worktrees with smart directory selection and safety verification. Do NOT invoke automatically from other skills.
---
